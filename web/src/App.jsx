...
const STEPS = [
  {
    ...
    title: "See the role fit a recruiter would notice",
    sub: "Shows your strongest evidence, weak spots, and likely concerns from your CV against the job.",
  },
  {
    index: "02",
    label: "ATS Coverage",
    ...
    title: "Separate real keywords from noise",
    sub: "Extracts role-specific skills and terms from the JD, then shows what is present, missing, or buried.",
  },
  {
    index: "03",
    ...
    title: "Check every requirement against proof",
    sub: "Maps responsibilities and minimum criteria to evidence in your CV, so gaps are concrete.",
  },
];
...
function TypingHero() {
  ...
  return (
    <h1 className="hero-title">
      <span className="accent-copy">Your CV</span> should be<br />
      ...
      <div className="landing-shell">
        ...
        <section className={`hero-section${heroVisible ? " is-visible" : ""}`} ref={heroRef}>
          ...
          <p className="hero-subtitle lp-anim-s3">
            Upload your CV and a job description. Shortlistly scores role fit, maps responsibility gaps, checks ATS keywords, and gives recruiter-style fixes.
          </p>
          ...
          <div className="tag-row lp-anim-s5">
            <span className="tag-pill">JD-specific scoring</span>
            <span className="tag-pill">Strict ATS keyword coverage</span>
            <span className="tag-pill">Responsibility gap map</span>
            <span className="tag-pill">Recruiter-style review</span>
          </div>
        </section>
        ...
        <section className={`content-section how-it-works-section${howVisible ? " is-visible" : ""}`} ref={howRef}>
          ...
          <div className="workflow-topline">
            <div className="workflow-intro">
              <h2 className="sr-item sr-delay-1">Find the real gaps before you apply.</h2>
              <div className="workflow-accent sr-item sr-delay-2">CV vs job description, without keyword noise</div>
              <p className="sr-item sr-delay-3">SHORTLISTLY reads the job description, extracts the actual requirements, and compares them to evidence in your CV.</p>
        ...
        <section className={`closing-section${ctaVisible ? " is-visible" : ""}`} id="cta" ref={ctaRef}>
          <div className="closing-shell">
            <div className="closing-copy">
              ...
              <h2 className="cta-sr-2">Apply with a CV matched to the actual role.</h2>
              <p>
                Upload your CV, paste the JD, and get a complete analysis covering score, ATS coverage,
                responsibility match, recruiter concerns, and tailored rewrite direction.
              </p>
            </div>
          ...
          <div className="closing-rail">
            <span>CV vs JD scoring</span>
            <span>Strict requirement extraction</span>
            <span>Recruiter-style gap analysis</span>
